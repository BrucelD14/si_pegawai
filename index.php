	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> SI KEPEGAWAIAN</span>
			</a>
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'view-pegawai':
					...
					break;
				case 'status-pegawai':
					include "admin/pegawai/status_pegawai.php";
					break;
				case 'status-honorer':
					include "admin/pegawai/status_honorer.php";
					break;
				case 'data-gaji':
					include "admin/pegawai/data_gaji.php";
					break;
